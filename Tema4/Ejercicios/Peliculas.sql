...
select count(titulo) as numero_peliculas, genero from pelicula group by genero;
...
select id_pelicula from reparto group by id_pelicula having count(id_actor) = 0;

-- 20. Seleccionar las películas estrenadas en los últimos 10 años.
select * from pelicula where anio > 2026 - 10;
